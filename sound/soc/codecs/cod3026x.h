...
extern const struct regmap_config cod3026x_regmap;
extern int cod3026x_jack_mic_register(struct snd_soc_codec *codec);

#define COD3026X_OTP_MAX_REG		0x0f
#define COD3026X_MAX_REGISTER		0xde
#define COD3026X_OTP_REG_WRITE_START	0xd0

#define COD3026X_REGCACHE_SYNC_START_REG	0x0
#define COD3026X_REGCACHE_SYNC_END_REG	0x80
...
struct cod3026x_priv {
	...
	unsigned char otp_reg[COD3026X_OTP_MAX_REG];
 ...
 * Register values.
*/
#define COD3026X_00_BASE_REG			0x00
#define COD3026X_01_IRQ1PEND			0x01
#define COD3026X_02_IRQ2PEND			0x02
#define COD3026X_03_IRQ3PEND			0x03
#define COD3026X_04_IRQ4PEND			0x04
#define COD3026X_05_IRQ5PEND			0x05
#define COD3026X_06_IRQ1M			0x06
#define COD3026X_07_IRQ2M			0x07
#define COD3026X_08_IRQ3M			0x08
#define COD3026X_09_IRQ4M			0x09
#define COD3026X_0A_IRQ5M			0x0A
#define COD3026X_0B_STATUS1			0x0B
#define COD3026X_0C_STATUS2			0x0C
#define COD3026X_0D_STATUS3			0x0D

#define COD3026X_10_PD_REF			0x10
#define COD3026X_11_PD_AD1			0x11
#define COD3026X_12_PD_AD2			0x12
#define COD3026X_13_PD_DA1			0x13
#define COD3026X_14_PD_DA2			0x14
#define COD3026X_15_PD_DA3			0x15
#define COD3026X_16_PWAUTO_AD			0x16
#define COD3026X_17_PWAUTO_DA			0x17
#define COD3026X_18_CTRL_REF			0x18
#define COD3026X_19_SV_HP			0x19
#define COD3026X_1A_ZCD_DA			0x1a
#define COD3026X_1B_ZCD				0x1b
#define COD3026X_1C_SV_DA			0x1c

#define COD3026X_20_VOL_AD1			0x20
#define COD3026X_21_VOL_AD2			0x21
#define COD3026X_22_VOL_AD3			0x22
#define COD3026X_23_MIX_AD1			0x23
#define COD3026X_24_MIX_AD2			0x24
#define COD3026X_25_VOL_AD4			0x25
#define COD3026X_26_DSM_ADS			0x26

#define COD3026X_30_VOL_HPL			0x30
#define COD3026X_31_VOL_HPR			0x31
#define COD3026X_32_VOL_EP_SPK			0x32
#define COD3026X_33_CTRL_EP			0x33
#define COD3026X_34_CTRL_HP			0x34
#define COD3026X_35_CTRL_SPK			0x35
#define COD3026X_36_MIX_DA1			0x36
#define COD3026X_37_MIX_DA2			0x37
#define COD3026X_38_DCT_CLK1			0x38

#define COD3026X_40_DIGITAL_POWER		0x40
#define COD3026X_41_FORMAT			0x41
...
#define COD3026X_52_DAC_R_VOL			0x52
#define COD3026X_53_MQS				0x53
#define COD3026X_54_DNC1			0x54
#define COD3026X_55_DNC2			0x55
#define COD3026X_56_DNC3			0x56
#define COD3026X_57_DNC4			0x57
#define COD3026X_58_DNC5			0x58
#define COD3026X_59_DNC6			0x59
#define COD3026X_5A_DNC7			0x5a
#define COD3026X_5B_DNC8			0x5b
#define COD3026X_5C_DNC9			0x5c
#define COD3026X_5D_SPKLIMIT1			0x5d
#define COD3026X_5C_SPKLIMIT2			0x5e
#define COD3026X_5F_SPKLIMIT3			0x5f

#define COD3026X_60_OFFSET1			0x60
#define COD3026X_61_RESERVED			0x61
#define COD3026X_62_IRQ_R			0x62

#define COD3026X_70_CLK1_AD			0x70
#define COD3026X_71_CLK1_DA			0x71
#define COD3026X_72_DSM1_DA			0x72
#define COD3026X_73_DSM2_DA			0x73
#define COD3026X_74_TEST			0x74
#define COD3026X_75_AD_MIC3N_TRIM1		0x75
#define COD3026X_76_CHOP_DA			0x76
#define COD3026X_77_CTRL_CP			0x77
#define COD3026X_78_AD_MIC3N_TRIM2		0x78
#define COD3026X_79_SL_DA1			0x79
#define COD3026X_7A_SL_DA2			0x7a
...
/* OTP registers */
#define COD3026X_D0_CTRL_IREF1			0xd0
#define COD3026X_D1_CTRL_IREF2			0xd1
#define COD3026X_D2_CTRL_IREF3			0xd2
#define COD3026X_D3_CTRL_IREF4			0xd3
#define COD3026X_D4_OFFSET_DAL			0xd4
#define COD3026X_D5_OFFSET_DAR			0xd5
#define COD3026X_D6_CTRL_IREF5			0xd6
#define COD3026X_D7_CTRL_EP			0xd7
#define COD3026X_D8_CTRL_CP2			0xd8
#define COD3026X_D9_CTRL_CP3			0xd9
#define COD3026X_DA_CTRL_CP4			0xda
#define COD3026X_DB_CTRL_HPS			0xdb
#define COD3026X_DC_CTRL_EPS			0xdc
#define COD3026X_DD_CTRL_SPKS1			0xdd
#define COD3026X_DE_CTRL_SPKS2			0xde

/* COD3026X_01_IRQ1PEND */
...
/**
 * COD3026X_43_ADC_L_VOL, COD3026X_44_ADC_R_VOL
 * COD3026X_51_DAC_L_VOL, COD3026X_52_DAC_R_VOL
 */
...
/**  COD3026X_78_AD_MIC3N_TRIM2 **/
#define COD3026X_78_MIC_ON	COD3026X_78_AD_MIC3N_TRIM2
