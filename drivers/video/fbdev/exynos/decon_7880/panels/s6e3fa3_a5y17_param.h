#ifndef __S6E3FA3_A5Y17_PARAM_H__
#define __S6E3FA3_A5Y17_PARAM_H__

#include <linux/types.h>
#include <linux/kernel.h>
#include "dynamic_aid_s6e3fa3_a5y17.h"
...
static const unsigned char SEQ_HMT_ON[] = {
	0xB2,
	0x20, 0x47,	/* AOR 70% Setting */
	0x12, 0x12, 0x12, 0x00	/* AID 1-Cycle */
};

static const unsigned char SEQ_HMT_AID_REVERSE[] = {
	0xCB,
	0x28, 0x01, 0x00, 0x00, 0x00, 0x60, 0x80, 0x00,
	0x00, 0x0B, 0x06, 0x00, 0x00, 0x00, 0x04, 0x0E,
	0x00, 0x17, 0x6E, 0x00, 0x00, 0x00, 0x00, 0x18,
	0x00, 0x00, 0x00, 0x09, 0x73, 0x00, 0x00, 0x51,
	0x0F, 0x0D, 0x04, 0x05, 0x00, 0x83, 0x00, 0x00,
	0x00, 0x40, 0xC0, 0x06, 0x07, 0x84, 0x85, 0x83,
	0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x10, 0x02, 0x4F, 0x37, 0x00, 0x00, 0x04,
	0x00
};

static const unsigned char SEQ_HMT_OFF[] = {
	0xB2,
	0x00, 0x14,	/* AOR 0% Setting */
	0x12, 0x12, 0x12, 0x40	/* AID 4-Cycle */
};

static const unsigned char SEQ_HMT_AID_FORWARD[] = {
	0xCB,
	0x28, 0x01, 0x00, 0x00, 0x00, 0x60, 0x80, 0x00,
	0x00, 0x0B, 0x06, 0x00, 0x00, 0x00, 0x0C, 0x06,
	0x00, 0x17, 0x6E, 0x00, 0x00, 0x00, 0x00, 0x04,
	0x00, 0x00, 0x00, 0x09, 0x73, 0x00, 0x00, 0x51,
	0x0F, 0x0D, 0x04, 0x05, 0x00, 0x83, 0x00, 0x00,
	0x00, 0x40, 0xC0, 0x06, 0x07, 0x04, 0x85, 0x83,
	0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x10, 0x02, 0x4E, 0x37, 0x00, 0x00, 0x04,
	0x00
};
...
static unsigned char elvss_mpscon_offset_data[IBRIGHTNESS_HBM_MAX][3] = {
	[IBRIGHTNESS_002NIT] = {0xB6, 0xAC, 0x07},
	[IBRIGHTNESS_003NIT] = {0xB6, 0xAC, 0x07},
	[IBRIGHTNESS_004NIT] = {0xB6, 0xAC, 0x07},
	[IBRIGHTNESS_005NIT] = {0xB6, 0xAC, 0x07},
	[IBRIGHTNESS_006NIT] = {0xB6, 0xAC, 0x08},
	[IBRIGHTNESS_007NIT] = {0xB6, 0xAC, 0x09},
	[IBRIGHTNESS_008NIT] = {0xB6, 0xAC, 0x0A},
	[IBRIGHTNESS_009NIT] = {0xB6, 0xAC, 0x0B},
	[IBRIGHTNESS_010NIT] = {0xB6, 0xAC, 0x0C},
	[IBRIGHTNESS_011NIT] = {0xB6, 0xAC, 0x0D},
	[IBRIGHTNESS_012NIT] = {0xB6, 0xAC, 0x0E},
	[IBRIGHTNESS_013NIT] = {0xB6, 0xAC, 0x0F},
	[IBRIGHTNESS_014NIT] = {0xB6, 0xAC, 0x10},
	[IBRIGHTNESS_015NIT] = {0xB6, 0xAC, 0x11},
	[IBRIGHTNESS_016NIT] = {0xB6, 0xAC, 0x12},
	[IBRIGHTNESS_017NIT] = {0xB6, 0xAC, 0x13},
	[IBRIGHTNESS_019NIT] = {0xB6, 0xAC, 0x15},
	[IBRIGHTNESS_020NIT] = {0xB6, 0xAC, 0x16},
	[IBRIGHTNESS_021NIT] = {0xB6, 0xAC, 0x17},
	[IBRIGHTNESS_022NIT] = {0xB6, 0xAC, 0x17},
	[IBRIGHTNESS_024NIT] = {0xB6, 0xAC, 0x17},
	[IBRIGHTNESS_025NIT] = {0xB6, 0xAC, 0x17},
	[IBRIGHTNESS_027NIT] = {0xB6, 0xAC, 0x17},
	[IBRIGHTNESS_029NIT] = {0xB6, 0xAC, 0x17},
	...
	[IBRIGHTNESS_082NIT] = {0xB6, 0xBC, 0x17},
	[IBRIGHTNESS_087NIT] = {0xB6, 0xBC, 0x17},
	[IBRIGHTNESS_093NIT] = {0xB6, 0xBC, 0x17},
	[IBRIGHTNESS_098NIT] = {0xB6, 0xBC, 0x17},
	[IBRIGHTNESS_105NIT] = {0xB6, 0xBC, 0x16},
	[IBRIGHTNESS_111NIT] = {0xB6, 0xBC, 0x16},
	[IBRIGHTNESS_119NIT] = {0xB6, 0xBC, 0x15},
	[IBRIGHTNESS_126NIT] = {0xB6, 0xBC, 0x15},
	...
	[IBRIGHTNESS_465NIT] = {0xB6, 0xBC, 0x12},
...
/* platform brightness <-> gamma level */
static unsigned int brightness_table_hmt[EXTEND_BRIGHTNESS + 1] = {
	...
	[UI_MAX_BRIGHTNESS ... EXTEND_BRIGHTNESS] =		IBRIGHTNESS_HMT_105NIT
};
#endif /* CONFIG_LCD_HMT */
#endif /* __S6E3FA3_A5Y17_PARAM_H__ */
