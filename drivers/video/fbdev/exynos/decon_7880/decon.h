...
#define DISPLAY_DVFS_LEVEL_0		333000
#define DISPLAY_DVFS_LEVEL_1		222000
...
struct decon_device {
	...
	struct decon_lcd		dual_lcd_info;
	struct decon_win_rect		update_win;
	bool				need_update;
