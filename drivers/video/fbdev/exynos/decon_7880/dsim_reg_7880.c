...
#define M4S2_M_DPHY	0x10000000
#define M4S0_M_DPHY	0x00000001
...
void dsim_reg_set_dphy_timing_values(u32 id, struct dphy_timing_value *t)
{
	...
	if (!id)
		dsim_write(id, DSIM_PHYCTRL_M2, M4S2_M_DPHY);
	else
		dsim_write(id, DSIM_PHYCTRL_M2, M4S0_M_DPHY);
}
...
void dsim_reg_set_config(u32 id, struct decon_lcd *lcd_info, u32 data_lane_cnt)
{
	...
	dsim_reg_set_multipix(id, 0); /* 1pix/clk */
