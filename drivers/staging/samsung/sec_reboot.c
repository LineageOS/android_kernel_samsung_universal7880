...
#define EXYNOS_INFORM2	EXYNOS_PMU_INFORM2
#define EXYNOS_INFORM3	EXYNOS_PMU_INFORM3
#define EXYNOS_PS_HOLD_CONTROL EXYNOS_PMU_PS_HOLD_CONTROL
/* EXYNOS_INFORM2 */
#define	SEC_POWER_OFF	0x0
#define SEC_POWER_RESET	0x12345678
/* EXYNOS_INFORM3 */
...
static void sec_reboot(enum reboot_mode reboot_mode, const char *cmd)
{
	...
	exynos_pmu_write(EXYNOS_INFORM2, SEC_POWER_RESET);
